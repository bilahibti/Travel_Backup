            ...
            <div class="col-xxl">
                <div class="card">
                    <form class="form-horizontal"
                          action="{{ route('v1.backend.hotel-room.update', $edit->id) }}"
                          method="POST"
                        ...
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <h5 class="mb-0">Edit Hotel Room</h5>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select name="room_type"
                                            ...
                                            @foreach (['Standard', 'Deluxe', 'Suite', 'Superior', 'Family', 'Executive'] as $type)
                                                <option value="{{ $type }}"
                                                    {{ old('room_type', $edit->room_type) == $type ? 'selected' : '' }}>
                                                    {{ $type }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="number"
                                            name="capacity"
                                            value="{{ old('capacity', $edit->capacity) }}"
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="number"
                                            name="total_rooms"
                                            value="{{ old('total_rooms', $edit->total_rooms) }}"
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div id="amenities-container">
                                            @php
                                                $existingAmenities = old('amenities', $edit->amenities ?? []);
                                                if (empty($existingAmenities)) $existingAmenities = [''];
                                            @endphp
                                ...
                                <div class="col-lg-4 text-center">
                                    @if ($edit->foto)
                                        <img id="preview-image"
                                             src="{{ asset('storage/img-hotel-room/' . $edit->foto) }}"
...
<script>
    ...
    function resetPreview() {
        document.getElementById('preview-image').src =
            "{{ $edit->foto ? asset('storage/img-hotel-room/' . $edit->foto) : asset('backend/img/avatars/1.png') }}";
